    ...
    choices: [
      ...
      },
      {
        ...
        delayed: {
          weekOffset: 4,
          delta: { publicTrust: 2 },
          eventText: `The back-channel with INEC has produced a quiet outcome: three LGA results will stand with minor procedural corrections noted in a joint communiqué. No national story. Your ward structures are intact.`,
        },
      },
    ],
  },
    ...
    choices: [
      ...
      },
      {
        ...
        delayed: {
          ...
          eventText: `The 'rogue officials' story held until a reporter from Premium Times noticed that the ghost account numbers matched the donation ledger from your 2023 campaign. Your treasurer is not taking your calls.`,
        },
      },
      {
        ...
        delayed: {
          ...
          eventText: `The reform commission's report is 214 pages of what everyone already knew. Buried on page 89 is the real finding: the system was designed to be leaky. Fixing it will take longer than your term. But you started.`,
        },
      },
    ],
  },
    ...
    choices: [
      {
        ...
        delayed: {
          weekOffset: 3,
          delta: { publicTrust: 4 },
          eventText: `The Assembly has passed the 2025 Appropriation Bill following the Executive's release of supplementary spending records. The PAC has noted two line items for further audit. The Speaker called the response "a mature act of executive accountability."`,
        },
      },
      {
        ...
        delayed: {
          weekOffset: 4,
          delta: { publicTrust: 3, corruptionPressure: 3 },
          eventText: `The Chief of Staff has reached a quiet agreement with the Speaker's office. The budget will pass by the weekend. The terms are not public.`,
        },
      },
      {
