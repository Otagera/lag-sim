...
export function SkyMarinaStation({ x = 0, y = 0, scale = 1, opacity = 1 }: Props) {
  return (
    <g transform={`translate(${x},${y}) scale(${scale})`} opacity={opacity}>
      ...
      <path
        d="M51.5 88.9941V126.994M59.5 88.9941V126.994M67.5 88.9941V126.994M47 96.4941H72M47 104.494H72M47 112.494H72M47 120.494H72"
        stroke="#73B1C6"
        fill="none"
      />
      <path
        d="M9.5 88.9941V126.994M17.5 88.9941V126.994M25.5 88.9941V126.994M5 96.4941H30M5 104.494H30M5 112.494H30M5 120.494H30"
        stroke="#73B1C6"
        fill="none"
      />
    </g>
