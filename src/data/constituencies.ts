...
export const CONSTITUENCIES: ZoneInfo[] = [
  {
    key: 'lagosIsland',
    label: 'Lagos Island',
    description: 'Central business district and historic core',
  },
  {
    key: 'etiOsa',
    label: 'Eti Osa',
    description: 'Victoria Island, Ikoyi — affluent commercial hub',
  },
  ...
  { key: 'surulere', label: 'Surulere', description: 'Middle-class heartland, National Stadium' },
  {
    key: 'amuwoOdofin',
    label: 'Amuwo Odofin',
    description: 'Festac Town, Mile 2, industrial estates',
  },
  { key: 'apapa', label: 'Apapa', description: 'Port district, shipping and commerce' },
  {
    key: 'oshodiIsolo',
    label: 'Oshodi/Isolo',
    description: 'Transport and market nexus, Airport Road',
  },
  ...
  { key: 'kosofe', label: 'Kosofe', description: 'Ojota, Ketu — northern residential sprawl' },
  {
    ...
    description: 'Yaba, Ebute Metta, Makoko waterfront',
  },
  ...
  { key: 'agege', label: 'Agege', description: 'Dense urban north-west, old rail corridor' },
  {
    key: 'ifakoIjaye',
    label: 'Ifako/Ijaye',
    description: 'Ojokoro, Ifako — outer north-west fringe',
  },
  ...
  { key: 'epe', label: 'Epe', description: 'Fishing community, Lekki Free Zone hinterland' },
  {
    key: 'ikorodu',
    label: 'Ikorodu',
    description: 'Fast-growing northern district, ferry terminal',
  },
  { key: 'ojo', label: 'Ojo', description: 'Ojo, Alaba — south-western industrial fringe' },
  {
    key: 'ajeromiIfelodun',
    label: 'Ajeromi/Ifelodun',
    description: 'Ajegunle — densely packed waterfront slums',
  },
]
