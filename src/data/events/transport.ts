...
export const transportEvents: EventCard[] = [
  ...
  },
  {
    ...
    body: `Following two capsizing incidents in eight days — one fatal — NIMASA has suspended the Marina–Badore ferry service after a spot inspection found three of the route's six vessels operating beyond their structural service life. The route carries 15,000 daily commuters. By road, the same journey takes two hours. The Lagos Ferry Services Corp says replacement vessels are "under procurement." That procurement began in 2021. The two bodies recovered from last Thursday's incident have not yet been formally identified.`,
    severity: 'critical',
    category: 'transport',
    week: 25,
    choices: [
  ...
  {
    id: 'frsc-lastma-jurisdiction-clash',
    title: 'FRSC Arrests LASTMA Officers on Lagos–Ibadan Expressway',
    body: `Federal Road Safety Corps officers impounded a LASTMA tow truck and arrested two LASTMA officers after they attempted to move an illegally parked articulated vehicle on the Lagos–Ibadan Expressway at Berger — a federal road. FRSC says LASTMA has no enforcement mandate on federal highways. LASTMA says the vehicle was causing a jam that backed up 14 kilometres into the Lagos State road network, and Lagos cannot wait for FRSC to respond. The incident is trending: a video of a FRSC officer handcuffing a LASTMA officer is on 800,000 feeds. Your Transport Commissioner says this has been simmering for two years.`,
    severity: 'medium',
    category: 'transport',
    week: 20,
    choices: [
      {
        ...
        delayed: {
          ...
          eventText: `The Federal Ministry of Works has acknowledged the Lagos enforcement protocol request. A joint FRSC-LASTMA technical committee has been constituted. The two arrested LASTMA officers were released without charge.`,
        },
      },
      {
      ...
      },
      {
        ...
        delayed: {
          ...
          eventText: `The FRSC-LASTMA Joint Enforcement MOU was signed at Alausa. Both agencies will now operate jointly at Berger, Ojota, and the Lagos–Ibadan corridor. The incident video has 2.3 million views.`,
        },
      },
    ],
  },
