...
export const crisisEvents: EventCard[] = [
  ...
  {
    id: 'ebute-metta-building-collapse',
    title: 'Ebute Metta: Three-Storey 1950s Block Collapse',
    body: `A three-storey residential building on Olajide Street in Ebute Metta East has pancaked. Eleven people are confirmed dead; rescue operations are ongoing with 14 still unaccounted for. The building is among 200+ pre-1960 residential structures in Ebute Metta flagged in a 2021 LASBCA report as requiring urgent structural intervention. No intervention was funded. The building was occupied by 6 families, all tenants paying below-market rent to an absentee landlord registered offshore. The Ebute Metta community association is asking why the LASBCA report gathered dust for three years.`,
    severity: 'critical',
    category: 'crisis',
    week: 20,
    choices: [
      {
        ...
        delayed: {
          weekOffset: 12,
          delta: { infrastructureScore: 8, publicTrust: 5 },
          eventText: `LASBCA has completed the pre-1960 structural audit. 47 buildings have been evacuated across Ebute Metta, Bricklayers, and Olowogbowo. The exercise has been praised by the UN-Habitat Lagos office as the most comprehensive built-heritage intervention in West Africa this decade.`,
        },
      },
      {
        id: 'ebute-metta-only-investigation',
        label: 'Site-Specific Investigation — Arrest Absentee Landlord',
        description: 'Contained response. Trust +5, Civil Society +6. Corruption +3.',
        immediate: { publicTrust: 5, corruptionPressure: 3 },
        factionImpact: { civilSocietyMedia: 6 },
      },
      {
