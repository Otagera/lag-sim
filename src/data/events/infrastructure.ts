...
export const infrastructureEvents: EventCard[] = [
  ...
  {
    id: 'ikorodu-road-drain-collapse',
    title: 'Anthony Village: Drainage Collapse Under Ikorodu Road',
    week: 25,
    body: `The main culvert under Ikorodu Road at the Anthony Village interchange has partially collapsed. Streets from Maryland to Gbagada flood for three hours after every rain — a 2km waterlogged corridor cutting off the Oshodi–Berger axis. The ₦600m drainage upgrade contract was awarded three years ago. The contractor mobilised for four months, collected a 40% advance, then stopped. LASG records show completion certificates were filed. The Accountant-General is asking about the ₦240m advance.`,
    severity: 'medium',
    category: 'infrastructure',
    choices: [
      {
        ...
        delayed: {
          ...
          eventText: `The Ikorodu Road drainage upgrade has been completed by the replacement contractor. The Anthony Village flooding that featured in every wet season report is gone.`,
        },
      },
      {
        ...
        delayed: {
          ...
          eventText: `The Anthony drainage works are complete — 8 weeks after remobilisation. Premium Times has filed a FOI request on the contract history.`,
        },
      },
      {
    ...
    choices: [
      ...
      },
      {
        ...
        delayed: {
          ...
          eventText: `The independent structural review has returned its findings: 9 of the 14 buildings require mandatory remediation. The 3 most dangerous have been evacuated under the new enforcement order.`,
        },
      },
    ],
  },
