...
const BASE: CSSProperties = {
  ...
  cursor:         'pointer',
  transition:     'background-color 200ms ease, color 200ms ease, border-color 200ms ease, transform 120ms ease, opacity 150ms ease',
  userSelect:     'none',
  lineHeight:     1.3,
}
...
export function Button({ children, variant = 'primary', disabled, onClick, fullWidth, style }: ButtonProps) {
