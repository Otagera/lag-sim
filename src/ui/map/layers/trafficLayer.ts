...
const ROADS: RoadPath[] = [
  ...
  {
    id: 'bridge',
    waypoints: [[22, 34], [28, 34], [36, 34], [42, 33], [48, 33], [52, 33]],
    zoneId: 'mainland',
    dotCount: 45,
    speedBase: 0.18,
    isBridge: true,
  ...
  {
    id: 'mainland-ew',
    waypoints: [[3, 18], [10, 18], [18, 18], [28, 18], [38, 18]],
    zoneId: 'mainland',
    dotCount: 38,
    speedBase: 0.13,
    isBridge: false,
  ...
  {
    id: 'mainland-ns',
    waypoints: [[14, 5], [14, 12], [16, 20], [18, 28], [20, 34]],
    zoneId: 'mainland',
    dotCount: 24,
    speedBase: 0.10,
    isBridge: false,
  ...
  {
    id: 'alimosho',
    waypoints: [[30, 4], [36, 6], [42, 8], [48, 10]],
    zoneId: 'alimosho',
    dotCount: 18,
    speedBase: 0.12,
    isBridge: false,
  ...
  {
    id: 'apapa',
    waypoints: [[46, 12], [50, 16], [54, 22], [56, 28]],
    zoneId: 'apapa',
    dotCount: 16,
    speedBase: 0.08,
    isBridge: false,
  ...
  {
    id: 'island',
    waypoints: [[52, 30], [55, 34], [58, 38], [59, 44]],
    zoneId: 'lagosIsland',
    dotCount: 26,
    speedBase: 0.15,
    isBridge: false,
  ...
  {
    id: 'lekki',
    waypoints: [[60, 56], [65, 61], [70, 65], [75, 70]],
    zoneId: 'lekki',
    dotCount: 18,
    speedBase: 0.20,
    isBridge: false,
  ...
  {
    id: 'ikorodu',
    waypoints: [[4, 46], [8, 50], [14, 55], [20, 60]],
    zoneId: 'ikorodu',
    dotCount: 16,
    speedBase: 0.09,
    isBridge: false,
  ...
  function buildPool(ox: number, oy: number) {
    ...
    for (let pi = 0; pi < ROADS.length; pi++) {
      ...
      for (let i = 0; i < road.dotCount; i++) {
        ...
        const isHeadlight = !isBRT && r < road.brtShare + 0.20
        ...
        sp.alpha    = isBRT ? 0.40 : isHeadlight ? 0.28 : 0.35
        ...
        _dots.push({
          ...
          speed:   road.speedBase * (0.80 + rng() * 0.40),
          isBRT,
        })
      }
    }
  ...
  return {
    ...
    update(state: MapState, dt: number) {
      ...
      for (const dot of _dots) {
        ...
        const speedMult = Math.max(0.20, infra / 50)
