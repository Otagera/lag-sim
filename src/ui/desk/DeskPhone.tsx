...
export function DeskPhone({ x = 0, y = 0, scale = 1, ringing = false }: Props) {
  ...
  return (
    <g transform={`translate(${x},${y}) scale(${scale})`}>
      ...
      <path
        d="M6,40 Q3,40 3,36 L4,24 Q4.5,20 9,20 L31,20 Q35.5,20 36,24 L37,36 Q37,40 34,40 Z"
        fill="#2c2925"
      />
      <path
        d="M6,40 Q3,40 3,36 L4,24 Q4.5,20 9,20 L31,20 Q35.5,20 36,24 L37,36 Q37,40 34,40 Z"
      ...
      {/* Cord — coiled */}
      <path
        d="M33,15 Q37,16 35,18 Q33,20 35,22 Q37,24 35,26 Q33.5,27.5 34,29"
        fill="none"
        stroke="#3a352d"
        strokeWidth="1.3"
        strokeLinecap="round"
      ...
      <circle
        ...
        cy="36"
        r="1.8"
        fill={ringing ? '#D7322A' : '#4a453d'}
        style={ringing ? blinkStyle : undefined}
      />
    </g>
  )
}
