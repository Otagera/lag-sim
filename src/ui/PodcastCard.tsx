  ...
  return (
    ...
    >
      ...
      <div style={{ flex: 1, minWidth: 0 }}>
        ...
        <div
          style={{ color: 'rgba(255,240,180,0.9)', fontSize: 14, fontWeight: 600, lineHeight: 1.3 }}
        >
          {headline}
        </div>
      </div>
      <div style={{ color: 'rgba(200,168,75,0.6)', fontSize: 12, flexShrink: 0 }}>{duration}</div>
    </div>
  )
}

function PodcastPlayer({ duration }: { duration: string }) {
  return (
...
function ProgressBar({ duration }: { duration: string }) {
  return (
...
function KeyQuote({ quote }: { quote: string }) {
  return (
    <div
      style={{
        margin: '0 20px 14px',
...
function HostFooter({
  ...
  return (
    ...
    >
      <HostIdentity hostName={hostName} week={week} />
...
function HostIdentity({ hostName, week }: { hostName: string; week: number }) {
  return (
